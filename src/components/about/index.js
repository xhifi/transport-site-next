const index = () => {
  return (
    <div id="#about" className="text-center bg-primary bg-gradient p-5 shadow text-white">
      ...
      <p>
        At Active Transports, we are more than just an automobile transportation service – we are your dedicated partners in seamless,
        reliable, and secure vehicle transport. With a commitment to excellence, a network of professionals, and a passion for delivering
        exceptional service, we ensure your vehicles reach their destination with the utmost care and efficiency.
      </p>
    </div>
  );
};
